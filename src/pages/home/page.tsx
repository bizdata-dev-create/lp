        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-8">
            ...
            <p className="text-center text-gray-700 max-w-3xl mx-auto leading-relaxed">
              リスト作成と営業文章は<strong className="bg-marker-yellow font-bold">何度でも無料で</strong>作成・修正いたします。
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {/* 初期費用0円 */}
            <div className="bg-brand-blue rounded-xl py-4 md:py-6 px-4 md:px-8 text-center shadow-xl hover:shadow-2xl transition-shadow duration-300 transform hover:-translate-y-1 border border-blue-700/20">
